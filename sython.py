...
@sython.on(events.NewMessage(outgoing=False, pattern='كارلوس'))
...
async def _(event):
      await event.reply("""السـورس يعمـل | IRTHON
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
- المطور : كارلوس  | KIRLOS 
- سورس بسيط يحتوي على الاوامر المهمة التي تحتاجها
قناة السورس : https://t.me/IRTHON
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""SY OWNER : @Q44UU"""
)
...
print("- lucithon Userbot Running ..")
